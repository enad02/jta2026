...
const PRIORITY_TOOLS = [
  {
    ...
    text: 'Use JTD02 after observation or teaching to record reflection, development focus, and next-step action.',
    url: LINKS.tutorReflectionForm,
    button: 'Open Tutor Form',
    variant: 'primary',
  },
  {
    title: 'Mentor Observation Form',
    text: 'Use JTD04 to record observations, coaching points, sign-off contribution, and evidence.',
    url: LINKS.mentorObservationForm,
    button: 'Open Mentor Form',
    variant: 'secondary',
  },
  {
    title: 'Panel Dashboard',
    text: 'Use JTD05 to review competency coverage, sign-off evidence, tutor progression, and panel readiness.',
    url: LINKS.panelDashboard,
    button: 'Open Panel Dashboard',
    variant: 'secondary',
  },
];
...
function createPriorityCard({ title, text, url, button, variant }) {
  ...
  actions.appendChild(createButton(button, url, variant));
...
function mountPriorityTools() {
  ...
  PRIORITY_TOOLS.forEach((tool) => {
    priorityTools.appendChild(createPriorityCard(tool));
  });
}
...
function mountButtons() {
  ...
  if (tutorButtons) {
    tutorButtons.append(
      ...
      createButton('Open Tutor Form', LINKS.tutorReflectionForm, 'secondary'),
  ...
  if (mentorButtons) {
    mentorButtons.append(
      ...
      createButton('Open Mentor Form', LINKS.mentorObservationForm, 'secondary'),
